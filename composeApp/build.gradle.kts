...
android {
    namespace = "vip.xsinfo.xslearn.xslearn"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "vip.xsinfo.xslearn.xslearn"
...
compose.desktop {
    application {
        mainClass = "vip.xsinfo.xslearn.xslearn.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "vip.xsinfo.xslearn.xslearn"
